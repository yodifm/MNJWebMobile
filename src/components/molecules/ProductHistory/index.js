...
const styles = StyleSheet.create({   
    ...
    key_user:{fontSize: 11, fontFamily:'Poppins-light', color:'#000', marginLeft:20},
    info:{flexDirection:'row'},
    key_date:{fontSize: 10, fontFamily:'Poppins-light', color:'#000', marginLeft:20},
    key_time:{fontSize: 10, fontFamily:'Poppins-light', color:'#000', marginLeft:120},
